...
const Header = () => {
  ...
  return (
    <div>
      <header
        className={`p-4 fixed w-full   dark:bg-gray-800 dark:text-gray-100 text-orange-200 `}
      >
          ...
          >
            <ul className={` md:p-0 p-5  lg:flex-row flex-col flex mx-auto`}>
              <li className="flex">
                <Link
                  to="/courses"
                  className="flex items-center px-4 md:-mb-1 border-b-2 mx-1 dark:border-transparent hover:bg-black text-orange-200"
                >
                  Courses
                </Link>
              </li>
              <li className="flex">
                <Link
                  to="/faq"
                  className="flex items-center px-4 md:-mb-1 border-b-2 dark:border-transparent hover:bg-black mx-1  text-orange-200"
                >
                  Faq
                </Link>
              </li>
              <li className="flex">
                <Link
                  to="/blog"
                  className="flex items-center px-4 md:-mb-1 border-b-2 dark:border-transparent hover:bg-black text-orange-200"
                >
                  Blog
                </Link>
              </li>
